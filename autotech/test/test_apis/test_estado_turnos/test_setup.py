...
class TestSetUp(APITestCase):
    ...
    def setUp(self):
        ...
        self.turno_taller6 = G(Turno_taller, tipo='service', tecnico_id=1, estado='en_proceso', taller_id=self.taller, papeles_en_regla=True) # id 6
        self.turno_taller7 = G(Turno_taller, tipo='evaluacion', tecnico_id=1, estado='en_proceso', taller_id=self.taller,papeles_en_regla=True ) # id 7
        self.turno_taller8 = G(Turno_taller, tipo='extraordinario', tecnico_id=1, estado='en_proceso', taller_id=self.taller, papeles_en_regla=True) # id 8
        self.turno_taller9 = G(Turno_taller, tipo='reparacion', tecnico_id=1, estado='en_proceso', taller_id=self.taller, papeles_en_regla=True) # id 9
