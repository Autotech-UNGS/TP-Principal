...
urlpatterns = [
    path('garantia-vigente/<str:patente>/<str:fecha_turno>/<int:service_solicitado>/', verificar_modificar_garantias.VerificarEstadoGarantia.as_view({'get': 'garantia_vigente'}), name='garantia-vigente'),
