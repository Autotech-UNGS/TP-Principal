...
def dias_disponibles_desde_hoy_a_treinta_dias(id_taller: int):
    ...
    cargar_turnos_desde_hoy_a_treinta_dias(agenda)
...
def cargar_turnos_desde_hoy_a_treinta_dias(agenda:Agenda):
    dia = date.today()
    for i in range(31):
        cargar_turnos_taller(dia, agenda)
        dia = dia + timedelta(days=1) 

def cargar_turnos_taller(dia:date, agenda:Agenda):
